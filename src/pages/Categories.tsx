    ...
    <>
      ...
      <div className="border-b border-[#D4E8E7] bg-[#EAF4F3]">
        <div className="mx-auto max-w-[1400px] px-4 py-6 md:px-6 md:py-8">
          ...
          <h1 className="text-2xl font-medium text-[#1E3333]">Categories</h1>
          <p className="mt-1 max-w-2xl text-sm text-[#6B8E8E]">
          ...
          {VIDEO_CATEGORIES.map((category) => {
            ...
            return (
              <Link
                ...
                to="/category/$slug"
                params={{ slug }}
                className="group rounded-2xl border border-[#D4E8E7] bg-white p-5 transition-colors hover:border-[#88C1BD] hover:bg-[#F9FCFC]"
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-base font-medium text-[#1E3333] transition-colors group-hover:text-[#2D6E6A]">
                      {category}
                    </p>
                  ...
                  <span className="text-[#88C1BD] transition-transform group-hover:translate-x-0.5">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 24 24"
