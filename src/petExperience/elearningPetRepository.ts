...
// adapter connecting the shared `pet-function/pet`
...
// `pet-function/contracts` types and the Supabase
// client for pet data — the shared package itself must never see any of
// these table names.
import type { PetRepository } from 'pet-function/contracts';
import type { FoodItem, PetInventoryItem, PetSaveSnapshot } from 'pet-function/contracts';
