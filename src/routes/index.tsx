...
const communityRoute = createRoute({
  ...
  path: '/community',
  validateSearch: (search: Record<string, unknown>) => ({
    tab: search.tab === 'following' || search.tab === 'friends' || search.tab === 'communities' || search.tab === 'video' || search.tab === 'chat' || search.tab === 'me' || search.tab === 'settings' ? search.tab : undefined,
