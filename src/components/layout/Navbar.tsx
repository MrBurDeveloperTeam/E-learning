...
export function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-[100] flex items-center justify-around border-t border-border bg-background px-2 py-2 md:hidden safe-area-pb">
