...
import { fetchNotifications } from '@/lib/queries/notifications';
import { fetchOwnVideoAnalyticsSnapshot } from '@/lib/queries/videos';
import { createUseElearningPersonalizedInsightState } from '@mrburdeveloperteam/pet-function/apps/elearning';
export type { ElearningInsightState } from '@mrburdeveloperteam/pet-function/apps/elearning';
export const useElearningPersonalizedInsightState = createUseElearningPersonalizedInsightState({ useQuery, useAuthStore, useFollowing, fetchNotifications, fetchOwnVideoAnalyticsSnapshot });
