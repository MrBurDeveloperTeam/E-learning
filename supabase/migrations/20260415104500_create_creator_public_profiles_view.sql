create or replace view public.creator_public_profiles as
select
  p.user_id,
  p.name,
  p.full_name,
...
grant select on public.creator_public_profiles to anon;
grant select on public.creator_public_profiles to authenticated;
